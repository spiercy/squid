...
SSL_CTX * GenerateSslContext(CertificateProperties const &properties, AnyP::PortCfg &port, bool) STUB_RETVAL(NULL)
bool verifySslCertificate(SSL_CTX * sslContext,  CertificateProperties const &properties) STUB_RETVAL(false)
SSL_CTX * GenerateSslContextUsingPkeyAndCertFromMemory(const char * data, AnyP::PortCfg &port, bool) STUB_RETVAL(NULL)
