...
public:
    ...
    Config() : authenticateChildren(20), authenticateProgram(NULL), requestFormat(NULL), requestRealm(NULL) {}
...
public:
    ...
    String requestFormatLine;  ///< The format of the request to the auth helper
    Format::Format *requestFormat; ///< The compiled request format
    String requestRealmFormat; ///< The realm of the request to use for caching helper results
    Format::Format *requestRealm; ///< The compiled requestRealm
};
