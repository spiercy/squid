 ...
 */
bool ReadX509Certificate(BIO_Pointer &bio, X509_Pointer & cert);
 ...
 */
bool WriteX509Certificate(BIO_Pointer &bio, const X509_Pointer & cert);
...
bool CertificatesCmp(const X509_Pointer &cert1, const X509_Pointer &cert2);
} // namespace Ssl
