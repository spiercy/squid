...
public:
    ...
    bool find(std::string const & key,  const Ssl::X509_Pointer &expectedOrig, Ssl::X509_Pointer & cert, Ssl::EVP_PKEY_Pointer & pkey);
    /// Delete a certificate from database
    bool purgeCert(std::string const & key);
    /// Save certificate to disk.
    bool addCertAndPrivateKey(std::string const & useKey, const Ssl::X509_Pointer & cert, const Ssl::EVP_PKEY_Pointer & pkey, const Ssl::X509_Pointer &orig);
...
private:
    ...
    bool pure_find(std::string const & key, const Ssl::X509_Pointer & expectedOrig, Ssl::X509_Pointer & cert, Ssl::EVP_PKEY_Pointer & pkey);
    ...
    static bool WriteEntry(const std::string &filename, const Ssl::X509_Pointer & cert, const Ssl::EVP_PKEY_Pointer & pkey, const Ssl::X509_Pointer &orig);

    /// loads a db entry from the file
    static bool ReadEntry(std::string filename, Ssl::X509_Pointer & cert, Ssl::EVP_PKEY_Pointer & pkey, Ssl::X509_Pointer &orig);
